...
@section('content')
    <h3 class="page-heading"></h3>
        <h1><i class='fa fa-table'></i> Users</h1>
        <h3>Users in {{ $country->name }}</h3>
        <small> Total Users <span class="label label-primary">{{ sizeof($users) }}</span></small>
        <br>
    ...
    {{--<div class="widget bg-lightblue-1 row">--}}
        {{--<div class="col-md-12">--}}
            {{--<div class="well">--}}
            {{--<div class="row">--}}
                    {{--<div class="col-lg-6">--}}
                        {{--<h1>Users in {{ $country->name }}</h1>--}}
                        {{--<small> Total Users =>  {{ sizeof($users) }}</small>--}}
                    {{--</div>--}}
                    {{--<div class="col-lg-3 col-md-offset-3">--}}
                        {{--<a href="{{ route('user.list') }}" class="btn btn-md btn-block buttonCustomPrimary">View All users</a>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
            {{--<table class="table">--}}
